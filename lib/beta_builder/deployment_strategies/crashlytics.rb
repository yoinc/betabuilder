      ...
      def deploy
        ...
        begin
          ...
          unless res
            ...
            res = system("bubonic/ext/Crashlytics.framework/submit #{@configuration.api_key} #{@configuration.build_secret} -ipaPath #{@configuration.ipa_path} -emails #{@configuration.emails} -notesPath #{filepath}")
            if res
